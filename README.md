...
- [لينكس 64-بت](https://github.com/3ammoori/arcli/releases/download/arcli/arcli-linux-x64.zip)
...
تأكد من تغيير `./arcli` إلى مسار الملف التنفيذي الفعلي في ملفاتك.
```bash
./arcli font1 النص
